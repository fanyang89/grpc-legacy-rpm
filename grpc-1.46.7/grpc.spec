...
# https://docs.fedoraproject.org/en-US/packaging-guidelines/Python/#_provides_for_importable_modules
%py_provides python3-grpc-admin
...
%changelog
* Fri May 12 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-10
- Add %%py_provides for importable modules

* Fri May 12 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-9
- List directories with trailing slashes

* Fri May 12 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-8
- List .so files more precisely

* Fri May 12 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-7
- Update rpmlintrc rules

* Fri May 12 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-6
- Hardlink duplicate files in the examples

* Fri May 12 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-5
- List doc/example files more explicitly
- Drop some less-relevant text documentation files

* Fri May 12 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-4
- Update License to include header-only dependencies

* Fri May 12 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-3
- Update License fields to SPDX

* Fri May 12 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-2
...
* Fri Mar 03 2023 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.7-1
- Update to 1.46.7

* Sat Nov 19 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.4-2
- Fix wrong paths in .pc files

* Sat Aug 27 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.4-1
- Update to 1.46.4

* Fri Aug 05 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.3-9
- Add dependency on grpc-plugins from grpc-devel

* Fri Aug 05 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.3-8
- Use new upstream PR#25635 as .pc path fix

* Sun Jul 31 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.3-7
- Rebuilt for libre2.so.9 (bumped from libre2.so.0a)

* Sat Jul 30 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.3-6
- Rebuilt (actually bootstrap!) for libre2.so.9 (bumped from libre2.so.0a)

* Fri Jul 29 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.3-5
- Rebuilt (bootstrap) for libre2.so.9 (bumped from libre2.so.0a)

* Tue May 24 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.3-4
- Non-bootstrap build for EPEL9

* Sat May 21 2022 Benjamin A. Beasley <code@musicinmybrain.net> - 1.46.3-3
- Bootstrap for EPEL9
